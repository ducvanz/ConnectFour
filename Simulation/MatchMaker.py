...
=======
        ...
        if (train_export_path is not None) and (label_export_path is not None) :
            self.train_export_path = train_export_path
            self.label_export_path = label_export_path
            self.game = ConnectFourBoard(first_to_move=FIRST_MOVING, shape=shape, save_history=True)
        
        else :
            self.train_export_path = None
            self.label_export_path = None
            self.game = ConnectFourBoard(first_to_move=FIRST_MOVING, shape=shape, save_history=False)
...
<<<<<<< Updated upstream
        ...
        # End of game loop
=======
            # print(self.game.history[current_turn][-1])
...
<<<<<<< Updated upstream
        ...
        games=1
=======
        player2=MinimaxAndRandom(depth=5, random_percent_start=0.85, random_percent_end=0.05),
        player1=MinimaxAndRandom(depth=5, random_percent_start=0.65, random_percent_end=0.20),
        display_game=True,
        delay=0,
        games=100,
